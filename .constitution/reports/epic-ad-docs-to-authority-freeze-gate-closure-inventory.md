...
- The normative docs claim inventory covers 237 matrix rows and 234 independent claims from `docs/KrakenFrameworkSpecification.md` and `docs/KrakenKernelSpecification.md`.
