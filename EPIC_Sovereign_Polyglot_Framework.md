...
│
├── tools/                      # build / enforcement / codegen tooling + the certification harness (renamed from tools/conformance/runner/)
