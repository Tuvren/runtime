...
- Live constitutional documents:
  - `constitution/PRD.md` (capability scope: CAP-P0-037, CAP-P1-035, CAP-P1-036, CAP-P1-038, CAP-P1-032)
  - `constitution/Architecture.md`
  - `constitution/TechSpec.md` (`§2.1`, `§3.1`, `§4.6`, `§4.11`, `§4.12`, `§4.13`, `§5.4`, ADR-023-033)
  - `constitution/Tasks.md` (Epic AL definition, build order, DoD)
...
- **Current state**: `tools/schemas/authority-packet.schema.json` line 117-127 lists
  ...
  embedded JSON Schema in `constitution/TechSpec.md` §4.11 (lines 1796-1804) lists
