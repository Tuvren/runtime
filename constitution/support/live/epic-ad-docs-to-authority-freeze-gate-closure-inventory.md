...
- The normative docs claim inventory covers 233 matrix rows and 230 independent claims from `docs/KrakenFrameworkSpecification.md` and `docs/KrakenKernelSpecification.md`.
...
- Summary: `constitution/support/live/epic-ad-docs-to-authority-freeze-gate-summary.md`
- Framework deferred decisions: `constitution/support/live/epic-ad-framework-deferred-surface-decisions.md`
